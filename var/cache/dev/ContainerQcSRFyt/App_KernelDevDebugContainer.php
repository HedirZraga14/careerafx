...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\BlockedUsersController' => 'getBlockedUsersControllerService',
            'App\\Controller\\CandidatureController' => 'getCandidatureControllerService',
            'App\\Controller\\CandidaturemissionController' => 'getCandidaturemissionControllerService',
            'App\\Controller\\ChatbotController' => 'getChatbotControllerService',
            'App\\Controller\\CherchermissionController' => 'getCherchermissionControllerService',
            'App\\Controller\\ChercheurController' => 'getChercheurControllerService',
            'App\\Controller\\CommunityController' => 'getCommunityControllerService',
            'App\\Controller\\DemandeMissionController' => 'getDemandeMissionControllerService',
            'App\\Controller\\EvenementsController' => 'getEvenementsControllerService',
            'App\\Controller\\EventModController' => 'getEventModControllerService',
            'App\\Controller\\EventTypeController' => 'getEventTypeControllerService',
            'App\\Controller\\ForumController' => 'getForumControllerService',
            'App\\Controller\\ForumDetailsController' => 'getForumDetailsControllerService',
            'App\\Controller\\FreelancerController' => 'getFreelancerControllerService',
            ...
            'App\\Controller\\MissionfreelencerController' => 'getMissionfreelencerControllerService',
            'App\\Controller\\ModerateurController' => 'getModerateurControllerService',
            ...
            'App\\Controller\\OffremodController' => 'getOffremodControllerService',
            ...
            'App\\Controller\\TypecontratController' => 'getTypecontratControllerService',
            'App\\Controller\\TypeoffreController' => 'getTypeoffreControllerService',
            ...
            'monolog.logger.security.access' => 'getMonolog_Logger_Security_AccessService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5MD4mZbQ5X', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v1TcgB5T78', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YKpBKJWxnn', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b01GVGfip2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $d = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry(['App\\Controller\\Admin\\UserCrudController' => 'App\\Entity\\User'], ['App\\Controller\\Admin\\UserCrudController' => 'fca38c1'], ['App\\Entity\\User' => 'App\\Controller\\Admin\\UserCrudController'], ['fca38c1' => 'App\\Controller\\Admin\\UserCrudController']);
    ...
    protected static function getEntityFactoryService($container)
    {
        ...
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\EntityFactory'] = new \EasyCorp\Bundle\EasyAdminBundle\Factory\EntityFactory(new \EasyCorp\Bundle\EasyAdminBundle\Factory\FieldFactory(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $b, new RewindableGenerator(function () use ($container) {
            ...
            yield 12 => ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Field\\Configurator\\ImageConfigurator'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Field\Configurator\ImageConfigurator('C:\\careera'));
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        ...
        }, 1), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', 'en');
    }
    ...
    protected static function getAssetMapperService($container)
    {
        ...
        }, 4), #[\Closure(name: 'asset_mapper', class: 'Symfony\\Component\\AssetMapper\\AssetMapper')] fn () => ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), 'C:\\careera/assets/vendor'), ($container->targetDir.''.'/asset_mapper'), true), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('C:\\careera/public/assets')));
    }
    ...
    {
        return $container->privates['asset_mapper.importmap.config_reader'] = new \Symfony\Component\AssetMapper\ImportMap\ImportMapConfigReader('C:\\careera/importmap.php', ($container->privates['asset_mapper.importmap.remote_package_storage'] ??= new \Symfony\Component\AssetMapper\ImportMap\RemotePackageStorage('C:\\careera/assets/vendor')));
    }
    ...
    {
        return $container->privates['asset_mapper.importmap.generator'] = new \Symfony\Component\AssetMapper\ImportMap\ImportMapGenerator(($container->privates['asset_mapper'] ?? self::getAssetMapperService($container)), ($container->privates['asset_mapper.compiled_asset_mapper_config_reader'] ??= new \Symfony\Component\AssetMapper\CompiledAssetMapperConfigReader('C:\\careera/public/assets')), ($container->privates['asset_mapper.importmap.config_reader'] ?? self::getAssetMapper_Importmap_ConfigReaderService($container)));
    }
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository(['C:\\careera\\vendor\\symfony\\ux-turbo\\src\\DependencyInjection/../../assets/dist' => '@symfony/ux-turbo', 'C:\\careera\\vendor\\symfony\\stimulus-bundle\\src\\DependencyInjection/../../assets/dist' => '@symfony/stimulus-bundle', 'assets/' => '', 'C:\\careera\\vendor\\easycorp\\easyadmin-bundle/public' => 'bundles/easyadmin'], 'C:\\careera', ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#'], true, true);
    }
    ...
    protected static function getAssets_PackagesService($container)
    {
        ...
        return $container->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\AssetMapper\MapperAwareAssetPackage(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy('C:\\careera/public/build/manifest.json', ($container->privates['.debug.http_client'] ?? self::get_Debug_HttpClientService($container)), false), new \Symfony\Component\Asset\Context\RequestStackContext(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a->getBaseUrl(), $a->isSecure())), ($container->privates['asset_mapper'] ?? self::getAssetMapperService($container))), new RewindableGenerator(function () use ($container) {
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VUv0vZo9nR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Tep9OBz1Ij', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('e1VHb5UgVo', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ivWF+dbDWY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lvXEjDLCJK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PDqX-uHUu8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MWFWcMczPB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L314WwccSX', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8zGdpRTXIs', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\Admin\\DashboardController', 'App\\Controller\\Admin\\UserCrudController', 'App\\Controller\\BlockedUsersController', 'App\\Controller\\CandidatureController', 'App\\Controller\\CandidaturemissionController', 'App\\Controller\\ChatbotController', 'App\\Controller\\CherchermissionController', 'App\\Controller\\ChercheurController', 'App\\Controller\\CommunityController', 'App\\Controller\\DemandeMissionController', 'App\\Controller\\EvenementsController', 'App\\Controller\\EventModController', 'App\\Controller\\EventTypeController', 'App\\Controller\\ForumController', 'App\\Controller\\ForumDetailsController', 'App\\Controller\\FreelancerController', 'App\\Controller\\HomeController', 'App\\Controller\\IndexController', 'App\\Controller\\MessageController', 'App\\Controller\\MissionfreelencerController', 'App\\Controller\\ModerateurController', 'App\\Controller\\NotificationController', 'App\\Controller\\OffreController', 'App\\Controller\\OffremodController', 'App\\Controller\\RegistrationController', 'App\\Controller\\ResetPasswordController', 'App\\Controller\\SecurityController', 'App\\Controller\\TypecontratController', 'App\\Controller\\TypeoffreController', 'App\\Controller\\UserDataController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['debug.file_link_formatter'] = new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\careera', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] fn () => ($container->privates['debug.file_link_formatter.url_format'] ?? $container->load('getDebug_FileLinkFormatter_UrlFormatService')));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver(['C:\\careera\\src\\Entity'], true)), 'App\\Entity');
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\BlockedUserRepository' => ['privates', 'App\\Repository\\BlockedUserRepository', 'getBlockedUserRepositoryService', true],
            'App\\Repository\\CandidatureRepository' => ['privates', 'App\\Repository\\CandidatureRepository', 'getCandidatureRepositoryService', true],
            'App\\Repository\\CandidaturemissionRepository' => ['privates', 'App\\Repository\\CandidaturemissionRepository', 'getCandidaturemissionRepositoryService', true],
            'App\\Repository\\DemandeMissionRepository' => ['privates', 'App\\Repository\\DemandeMissionRepository', 'getDemandeMissionRepositoryService', true],
            ...
            'App\\Repository\\MissionfreelencerRepository' => ['privates', 'App\\Repository\\MissionfreelencerRepository', 'getMissionfreelencerRepositoryService', true],
            ...
            'App\\Repository\\NotificationfreelencerRepository' => ['privates', 'App\\Repository\\NotificationfreelencerRepository', 'getNotificationfreelencerRepositoryService', true],
            ...
            'App\\Repository\\TypeContratRepository' => ['privates', 'App\\Repository\\TypeContratRepository', 'getTypeContratRepositoryService', true],
            'App\\Repository\\TypeEventRepository' => ['privates', 'App\\Repository\\TypeEventRepository', 'getTypeEventRepositoryService', true],
            'App\\Repository\\TypeOffreRepository' => ['privates', 'App\\Repository\\TypeOffreRepository', 'getTypeOffreRepositoryService', true],
            ...
            'App\\Repository\\CandidaturemissionRepository' => '?',
            'App\\Repository\\DemandeMissionRepository' => '?',
            ...
            'App\\Repository\\MissionfreelencerRepository' => '?',
            'App\\Repository\\NotificationRepository' => '?',
            'App\\Repository\\NotificationfreelencerRepository' => '?',
            ...
            'App\\Repository\\TypeEventRepository' => '?',
            'App\\Repository\\TypeOffreRepository' => '?',
    ...
    protected static function getRouterListenerService($container)
    {
        ...
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterList
\vendor\\doctrine\\doctrine-migrations-bundle/translations', 'C:\\careera\\vendor\\symfony\\debug-bundle/translations', 'C:\\careera\\vendor\\symfony\\twig-bundle/translations', 'C:\\careera\\vendor\\symfony\\web-profiler-bundle/translations', 'C:\\careera\\vendor\\symfony\\stimulus-bundle/translations', 'C:\\careera\\vendor\\symfony\\ux-turbo/translations', 'C:\\careera\\vendor\\twig\\extra-bundle/translations', 'C:\\careera\\vendor\\symfony\\security-bundle/translations', 'C:\\careera\\vendor\\symfony\\monolog-bundle/translations', 'C:\\careera\\vendor\\symfony\\maker-bundle/translations', 'C:\\careera\\vendor\\symfony\\webpack-encore-bundle\\src/translations', 'C:\\careera\\vendor\\symfony\\ux-twig-component/translations']]], []);
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($c, 'C:\\careera', 'UTF-8'));
    ...
    {
        $container->privates['twig.loader.native_filesystem'] = $instance = new \Twig\Loader\FilesystemLoader([], 'C:\\careera');

        $instance->addPath('C:\\careera\\vendor\\easycorp\\easyadmin-bundle\\src/../templates/', 'ea');
        $instance->addPath('C:\\careera\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $instance->addPath('C:\\careera\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $instance->addPath('C:\\careera\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $instance->addPath('C:\\careera\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $instance->addPath('C:\\careera\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $instance->addPath('C:\\careera\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $instance->addPath('C:\\careera\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\careera\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $instance->addPath('C:\\careera\\vendor\\symfony\\ux-turbo/templates', 'Turbo');
        $instance->addPath('C:\\careera\\vendor\\symfony\\ux-turbo/templates', '!Turbo');
        $instance->addPath('C:\\careera\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $instance->addPath('C:\\careera\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $instance->addPath('C:\\careera\\vendor\\symfony\\maker-bundle/templates', 'Maker');
        $instance->addPath('C:\\careera\\vendor\\symfony\\maker-bundle/templates', '!Maker');
        $instance->addPath('C:\\careera\\vendor\\symfony\\ux-twig-component/templates', 'TwigComponent');
        $instance->addPath('C:\\careera\\vendor\\symfony\\ux-twig-component/templates', '!TwigComponent');
        $instance->addPath('C:\\careera\\vendor\\easycorp\\easyadmin-bundle/templates', 'EasyAdmin');
        $instance->addPath('C:\\careera\\vendor\\easycorp\\easyadmin-bundle/templates', '!EasyAdmin');
        $instance->addPath('C:\\careera/templates');
        $instance->addPath('C:\\careera\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $instance->addPath('C:\\careera\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $instance->addPath('C:\\careera\\vendor\\symfony\\twig-bridge/Resources/views/Form');
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addXmlMappings(['C:\\careera\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\careera\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\careera\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'StimulusBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\stimulus-bundle',
                    'namespace' => 'Symfony\\UX\\StimulusBundle',
                ],
                'TurboBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\ux-turbo',
                    'namespace' => 'Symfony\\UX\\Turbo',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\careera\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\maker-bundle',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'WebpackEncoreBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\webpack-encore-bundle\\src',
                    'namespace' => 'Symfony\\WebpackEncoreBundle',
                ],
                'SymfonyCastsResetPasswordBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfonycasts\\reset-password-bundle\\src',
                    'namespace' => 'SymfonyCasts\\Bundle\\ResetPassword',
                ],
                'TwigComponentBundle' => [
                    'path' => 'C:\\careera\\vendor\\symfony\\ux-twig-component',
                    'namespace' => 'Symfony\\UX\\TwigComponent',
                ],
                'EasyAdminBundle' => [
                    'path' => 'C:\\careera\\vendor\\easycorp\\easyadmin-bundle',
                    'namespace' => 'EasyCorp\\Bundle\\EasyAdminBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'App_KernelDevDebugContainer',
            'uploads_directory' => 'C:\\careera/public/uploads',
            'images_directory' => 'C:\\careera/public/uploads/images',
            'cv_directory' => 'C:\\careera/public/uploads/cvs',
            'locale' => 'fr',
            ...
            'translator.default_path' => 'C:\\careera/translations',
            ...
            'twig.default_path' => 'C:\\careera/templates',
