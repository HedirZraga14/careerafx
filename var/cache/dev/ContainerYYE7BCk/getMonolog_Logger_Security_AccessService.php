 ...
 */
class getMonolog_Logger_Security_AccessService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'monolog.logger.security.access' shared service.
     *
     * @return \Monolog\Logger
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['monolog.logger.security.access'] = $instance = new \Monolog\Logger('security.access');
