...
public class AjouterChercheurController {
    ...
    private void ajouterChercheur(ActionEvent event) {
        ...
        try {
            ...
            showStatus("Chercheur ajouté avec succès !", Color.GREEN);
            clearForm();
        } catch (Exception e) {
    ...
    private boolean validateForm() {
        ...
        if (domaineField.getText().isEmpty()) {
            domaineField.setStyle("-fx-border-color: red;");
            isValid = false;
        }
    ...
    private Chercheur createChercheurFromForm() {
        ...
        chercheur.setDomaine(domaineField.getText());
